# ARCHIVED — Janavani PRIVACY_CONTRACT.md

**Historical version:** MVP v0.1
**Archived:** 11 September 2026
**Reason:** Superseded by the canonical privacy architecture in `docs/PRIVACY_ARCHITECTURE.md` and the Identity, Access & Trust contract.
