# ARCHIVED — Janavani DATABASE_DESIGN.md

**Historical version:** 1.0
**Archived:** 11 September 2026
**Reason:** Superseded by the current privacy-first, capability-oriented data boundary and provider-neutral storage architecture.

This file is preserved verbatim below for historical reference. It is **not** a current architecture authority.
