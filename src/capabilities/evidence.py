...
class EvidenceCapability:
    ...
    def register(
        ...
        *,
        ...
        """Register immutable evidence metadata without transmitting the artifact."""
        ...
        if self._repository.get(request.evidence_id if hasattr(request, "evidence_id") else "") is not None:
