...
class SessionManager:
    ...
    Persistence is intentionally left behind this boundary. A production
    ...
    def create_session(
        ...
        *,
        ...
        if not isinstance(principal_id, str) or not principal_id.strip():
            raise ValueError("principal_id must be a non-empty opaque identifier")
    ...
    def resolve(
        self, session_id: str, raw_token: str, *, interface: str = "unknown"
    ) -> IdentityContext:
        with self._lock:
