...
INDIA_PUBLIC_SERVICE_DESTINATIONS: tuple[PublicServiceDestination, ...] = (
    ...
    PublicServiceDestination(
        "india:cybercrime:1930",
        "Cyber Crime Helpline",
        "1930",
        ServiceCategory.CYBERCRIME,
        "india",
        ContactAction.CALL,
        SOURCE_URL,
        SOURCE_LABEL,
    ...
    PublicServiceDestination(
        "india:senior-citizens:14567",
        "Senior Citizens Helpline",
        "14567",
        ServiceCategory.SENIOR_CITIZENS,
        "india",
        ContactAction.CALL,
        SOURCE_URL,
        SOURCE_LABEL,
    ...
    PublicServiceDestination(
        "india:railway:139",
        "Railway Security/Medical Assistance Helpline",
        "139",
        ServiceCategory.RAILWAY,
        "india",
        ContactAction.CALL,
        SOURCE_URL,
        SOURCE_LABEL,
...
def get_public_service_destination(
    ref: str,
) -> PublicServiceDestination | None:
    return next(
        (item for item in INDIA_PUBLIC_SERVICE_DESTINATIONS if item.ref == ref),
        None,
    )
