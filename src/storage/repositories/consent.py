...
class ConsentRepository(Protocol):
    """Persistence contract independent of database or transport."""

    def save(self, consent: Consent) -> None:
        """Persist one complete consent record."""
        ...

    def get(self, consent_id: str) -> Consent | None:
        """Return one consent record by identifier."""
        ...

    def list_for_subject(self, subject_id: str) -> list[Consent]:
        """Return consent records belonging to one subject."""
        ...
