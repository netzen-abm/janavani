...
def create_civic_action_capability(*, case_repository: CivicCaseRepository,
    ...
    return CivicActionCapability(case_capability=create_case_capability(case_repository),
...
def create_constitutional_objection_capability(*, case_repository: CivicCaseRepository,
    ...
    return ConstitutionalObjectionCapability(case_capability=create_case_capability(case_repository),
                                             case_repository=case_repository,
                                             authority_repository=authority_repository,
