...
async def handle_office(
    update: Update,
    context: ContextTypes.DEFAULT_TYPE,
):
    """Persist the selected Authority-shaped office record and continue."""
    ...
    office_name = office.get("name") or office.get("office_name") or "Selected authority"
