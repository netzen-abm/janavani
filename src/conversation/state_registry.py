"""Canonical Telegram conversation state registry.

This module owns only state-to-handler routing. Workflow steps own their
individual interaction responsibilities; shared civic capabilities own domain
semantics.
"""
...
from conversation.steps.office_selection import handle_office_selection
...
STATE_HANDLERS = {
    ...
    WAITING_FOR_OFFICE_SELECTION: handle_office_selection,
