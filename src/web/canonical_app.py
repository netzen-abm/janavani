...
This module is the channel-neutral API assembly point. Domain behavior remains
in independently testable routers/services and can later be consumed by Web,
Android, iOS, Telegram, WhatsApp, DApp, and other adapters.
"""
