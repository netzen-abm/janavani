"""HTTP adapter for the shared, channel-neutral civic case contract."""
...
# Temporary process-local adapter. Persistent storage belongs to the shared
# storage capability and is intentionally not invented here.
