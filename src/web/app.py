...
from src.web.land_router import router as land_mapping_api_router
...
app.include_router(land_mapping_api_router)
...
# Register the core structural document parsing route zones
router = APIRouter(prefix="/api/v1/agent")
...
# Mount routes to the root app instance
app.include_router(router)
app.include_router(feedback_api_router)
