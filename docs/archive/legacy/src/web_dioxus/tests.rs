...
Reason: tests exercised the removed surface-owned mock Nostr/blockchain helper rather than a canonical Janavani capability. Preserved as historical evidence; not a current verification suite.
