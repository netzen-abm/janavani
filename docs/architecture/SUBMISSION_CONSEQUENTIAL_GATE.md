...
The Submission capability remains the domain authority for submission invariants and transport execution. The shared gate now decides whether the consequential operation may proceed.
