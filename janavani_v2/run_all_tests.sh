...
echo -e "\n🔹 [2/19] Running Headless Rust Dioxus WebAssembly Engine Component Tests..."
cd src/web_dioxus && cargo test --lib -- --nocapture
...
echo -e "\n🔹 Running De-linked Multi-Party Ingestion Integration Tests..."
pytest tests/ -v
...
echo -e "\n🔹 Running Core Python System Component Tests..."
pytest tests/ -v
